  ...
  class Layout
    ...
    def layout
      ...
      layout_string.gsub(/\{\{\{search\}\}\}/, '{{search}}').
                    ...
                    gsub(/\<script src="\/assets\/dist\/application.min.js">\<\/script>/, "<script src=\"#{base_url}/assets/dist/application.min.js?#{timestamp}\"></script>").
                    gsub(/\<link href="\/assets\/dist\/application\.css" rel="stylesheet" type="text\/css">/, "<link rel=\"stylesheet\" type=\"text/css\" href=\"#{base_url}/assets/dist/application.css?#{timestamp}\">").
                    gsub(/\<link href="\/assets\/images/, "<link href=\"#{base_url}/assets/images").
                    gsub(/kongmixpanel/, '9d0ac2764fd18a0b68a892557923c0ab').
                    gsub(/\<img src="\/assets/, "<img src=\"#{base_url}/assets").
                    gsub(assets_regex, "\"#{base_url}\\1?#{timestamp}\"").
                    gsub(/\{\{\> tictail\/misc\}\}/, '').
